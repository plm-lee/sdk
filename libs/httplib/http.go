...
var defaultTransport = &http.Transport{
	...
	// MaxIdleConns:        500,
	MaxIdleConnsPerHost: 50, // 同一个请求地址最多保持空闲连接数量 默认2
...
func (b *BeegoHttpRequest) SetDefaultTransport() *BeegoHttpRequest {
	b.setting.Transport = defaultTransport
	return b
}
...
func (b *BeegoHttpRequest) buildUrl(paramBody string) {
	...
	log.Println("beegoHttpRequest paramBody:", paramBody, b.req.Body == nil)
...
func (b *BeegoHttpRequest) getResponse() (*http.Response, error) {
	...
	client := &http.Client{ /*Timeout: b.setting.ConnectTimeout,*/
		Transport: trans,
		Jar:       jar,
	}
